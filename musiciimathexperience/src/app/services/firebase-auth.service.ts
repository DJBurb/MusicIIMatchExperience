...
import { User, OAuthProvider } from '@angular/fire/auth';
import { ProfileModel } from '../sharedModels/profile.model';
...
export class FirebaseAuthService {
  ...
  signInWithFacebook() {
    // const provider = new this.angularFireAuth.FacebookAuthProvider();
